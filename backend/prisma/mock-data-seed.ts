...
const MOCK_ITEMS = [
  ...
  {
    name: "Blue Frisbee",
    description: "Plastic flying disc, slightly worn",
    color_hex: "#0000FF",
    color_bucket: "BLUE",
    category: "Sports Equipment",
    building: "JWC Campus",
  ...
  {
    name: "Purple Pen Set",
    description: "Set of 5 colored gel pens",
    color_hex: "#800080",
    color_bucket: "PURPLE",
    category: "Other",
    building: "FX Campus",
  ...
  {
    name: "Orange Beanie",
    description: "Wool winter beanie cap",
    color_hex: "#FFA500",
    color_bucket: "ORANGE",
    category: "Clothing",
    building: "JWC Campus",
  ...
  {
    name: "Black USB Drive",
    description: "32GB SanDisk USB flash drive",
    color_hex: "#000000",
    color_bucket: "BLACK",
    category: "Electronics",
    building: "FX Campus",
  ...
  },
  {
    ...
    description: "Thermos water bottle with lid",
    color_hex: "#FF0000",
    color_bucket: "RED",
    category: "Personal Belonging",
    building: "JWC Campus",
  ...
  {
    name: "Pink Notebook",
    description: "Spiral-bound notebook with notes",
    color_hex: "#FFC0CB",
    color_bucket: "PINK",
    category: "Other",
    building: "FX Campus",
  ...
  },
  {
    ...
    description: "Silicone phone case for iPhone 14",
    color_hex: "#FFFFFF",
    color_bucket: "WHITE",
    category: "Electronics",
    building: "JWC Campus",
  ...
  {
    name: "Green Scarf",
    description: "Lightweight cotton scarf",
    color_hex: "#008000",
    color_bucket: "GREEN",
    category: "Clothing",
    building: "FX Campus",
  ...
  },
  {
    ...
    description: "Pack of yellow highlighter markers",
    color_hex: "#FFFF00",
    color_bucket: "YELLOW",
    category: "Other",
    building: "FX Campus",
...
const MOCK_CLAIMS = [
  ...
  {
    itemIndex: 11, // Black USB Drive
    claimerIndex: 0, // Test Claimer 1
    ownership_desc: "My 32GB SanDisk USB drive with important project files",
    status: "APPROVED" as const,
    requested_at: new Date("2025-05-21T10:00:00"),
    decision_at: new Date("2025-05-21T10:30:00"),
    approved_by: 2, // Staff Approver
    staff_notes: "Verified ownership - student confirmed file contents",
  },
  {
    itemIndex: 13, // Pink Notebook
    claimerIndex: 1, // Test Claimer 2
    ownership_desc: "My pink notebook from the auditorium - has my name written inside",
    status: "PENDING" as const,
    requested_at: new Date("2025-05-17T14:30:00"),
  },
  {
    itemIndex: 15, // Green Scarf
    claimerIndex: 0, // Test Claimer 1
    ownership_desc: "My cotton scarf that I left at the library",
    status: "APPROVED" as const,
    requested_at: new Date("2025-05-15T16:00:00"),
    decision_at: new Date("2025-05-15T16:45:00"),
    approved_by: 2, // Staff Approver
    staff_notes: "Ownership verified - matches description in lost item report",
  },
];
